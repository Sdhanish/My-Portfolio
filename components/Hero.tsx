  ...
  return (
    <section id='hero'
      className="
        ...
        bg-gradient-to-br from-slate-50 via-blue-100 to-blue-50
    ...
    >
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-blue-500/10 rounded-full blur-3xl animate-bounce-slow animation-delay-2000"></div>
      </div>
